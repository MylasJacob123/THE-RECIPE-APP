...
const Details = () => {
    ...
    return (
            ...
            <div class="detail-display">
                    ...
                    <div className="ingredients">
                        ...
                        <ul className="details-list-info">
                          {recipe.ingredients.map((ingredient, i) => (
                            <li className="details-list" key={i}>{ingredient}</li>
                          ))}
                        </ul>
                    </div>
                    <div>
                ...
                <div class="bottom">
                    <p><strong>Prep Time:</strong> <span>{recipe.prep}</span> </p>
                    <p><strong>Cook Time:</strong> <span>{recipe.cook}</span> </p>
                    <p><strong>Serves:</strong> <span>{recipe.serves}</span> </p>
                </div>
